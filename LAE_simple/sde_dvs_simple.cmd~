...
(sdegeo:create-rectangle (position 1.5 -0.2 0)  (position 2.5 -0.201 0) "InGaAs" "ntype_contact" )
(sdegeo:create-rectangle (position 1.5 1 0)  (position 2.5 1.001 0) "InP" "ptype_contact" )

(sdegeo:define-contact-set "ntype" 4  (color:rgb 1 0 0 ) "##" )
(sdegeo:set-current-contact-set "ntype")
(sdegeo:set-contact-edges (find-edge-id (position 2 -0.201 0)) "ntype")


(sdegeo:define-contact-set "ptype" 4  (color:rgb 1 0 0 ) "##" )
(sdegeo:set-current-contact-set "ptype")
(sdegeo:set-contact-edges (find-edge-id (position 2 1.001 0)) "ptype")
...
(sde:build-mesh "snmesh" "-a -c boxmethod" "sdemodel_simple")
