...
File{
	* input files:
	Grid=	"sdemodel_ntype_200_1E17_ptype_300_1E18_msh.tdr"
	Parameter= "sdevice.par"
	
	* output files:
	Plot=	"hetero_des_opt_0_bias_50_ntype_200_1E17_ptype_300_1E18.tdr"
	Current="hetero_des_opt_0_bias_50_ntype_200_1E17_ptype_300_1E18.plt"
...
Solve{ 
   ...
   Coupled { Poisson Electron Hole }  
    ...
    Quasistationary ( MaxStep = 0.01 MinStep = 1e-4 
                          Goal { Name= "ntype" Voltage =12.5}) 
                         { Coupled { Poisson Electron Hole } }
                         
    Quasistationary ( MaxStep = 0.01 MinStep = 1e-4 
                          Goal { Name= "ntype" Voltage =25.0}) 
                         { Coupled { Poisson Electron Hole } }
                         
    Quasistationary ( MaxStep = 0.01 MinStep = 1e-4 
                          Goal { Name= "ntype" Voltage =37.5}) 
                         { Coupled { Poisson Electron Hole } }
