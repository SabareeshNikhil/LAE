...
File{
	...
	* output files:
	Plot=	"trans_sde_des_opt_@light@_bias_@max_bias@_ntype_@n_width@_@n_doping@_ptype_@p_width@_@p_doping@_decay_@decay_length@.tdr"
	Current="trans_sde_des_opt_@light@_bias_@max_bias@_ntype_@n_width@_@n_doping@_ptype_@p_width@_@p_doping@_decay_@decay_length@.plt"
...
File {
    ...
    Output = "cv_opt_@light@_bias_@max_bias@_ntype_@n_width@_@n_doping@_ptype_@p_width@_@p_doping@_decay_@decay_length@.log"

        Plot = "cv_opt_@light@_bias_@max_bias@_ntype_@n_width@_@n_doping@_ptype_@p_width@_@p_doping@_decay_@decay_length@.dat"

        Current = "cv_opt_@light@_bias_@max_bias@_ntype_@n_width@_@n_doping@_ptype_@p_width@_@p_doping@_decay_@decay_length@.plt"

        ACExtract = "cv_opt_@light@_bias_@max_bias@_ntype_@n_width@_@n_doping@_ptype_@p_width@_@p_doping@_decay_@decay_length@.plt"
