(sdegeo:create-rectangle (position 0 0.6 0)  (position 14 1 0) "InP" "substrate" )
...
(sdegeo:create-rectangle (position 0 0.3 0)  (position 14 0.6 0) "InGaAs" "p_region" )
...
(sdegeo:create-rectangle (position 11 0.299 0)  (position 13 0.3 0) "Gold" "ptype_contact" )
...
(sdegeo:set-contact-edges (find-edge-id (position 12 0.299 0)) "ptype")
...
(sde:build-mesh "snmesh" "-a -c boxmethod" "sdemodel_ntype_300_1E16_ptype_300_1E18_decay_50")
