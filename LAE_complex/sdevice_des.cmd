...
File{
	...
	* output files:
	Plot=	"sde_des_opt_@light@_bias_@max_bias@_ntype_@n_width@_@n_doping@_ptype_@p_width@_@p_doping@.tdr"
	Current="sde_des_opt_@light@_bias_@max_bias@_ntype_@n_width@_@n_doping@_ptype_@p_width@_@p_doping@.plt"
