(sdegeo:create-rectangle (position 0 @<0.001*(n_width + p_width)>@ 0)  (position 14 1 0) "InP" "substrate" )
...
(sdegeo:create-rectangle (position 11 @<0.001*n_width - 0.001>@ 0)  (position 13 @<0.001*n_width>@ 0) "Gold" "ptype_contact" )
...
(sdegeo:set-contact-edges (find-edge-id (position 12 @<0.001*n_width - 0.001>@ 0)) "ptype")
...
(sde:build-mesh "snmesh" "-a -c boxmethod" "sdemodel_ntype_@n_width@_@n_doping@_ptype_@p_width@_@p_doping@_decay_@decay_length@")
