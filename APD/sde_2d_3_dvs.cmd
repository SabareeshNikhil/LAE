...
(sdegeo:create-rectangle 
  (position 2 0 0.0 )  (position 5 0.2 0.0 ) "Silicon" "p+" )
(sdedr:define-refeval-window 
...
(sdedr:define-refeval-window 
  "RefEvalWin_p+Implant_1" "Rectangle"  (position (- 2 0.1) 0 0.0 )  (position (+ 5 0.1) (+ 0.2 0.05) 0.0 ))
(sdedr:define-multibox-placement 
...
(sdegeo:create-rectangle 
  (position 5 0 0.0 )  (position 5.6 0.43 0.0 ) "Oxide" "STI" )
(sdedr:define-multibox-size "MultiboxDefinition_STI_1" 0.05 0.05 0 0.01 0.01 0 1.2 1.2 1 )
(sdedr:define-refeval-window 
  "RefEvalWin_STI_1" "Rectangle"  (position (- 5 0.1) 0 0.0 )  (position (+ 5 0.1) (+ 0.43 0.05) 0.0 ))
(sdedr:define-multibox-placement 
...
(sdedr:define-refeval-window 
  "RefEvalWin_STI_3" "Rectangle"  (position (- 5 0.1) (- 0.43 0.1) 0.0 )  (position (+ 5.8 0.1) (+ 0.43 0.1) 0.0 ))
(sdedr:define-multibox-placement 
...
;----------------------------------------------------------------------
; Build Mesh 
(sde:build-mesh "snmesh" " " "sde_2d_3_msh")
