...
(sdegeo:create-rectangle 
  (position 0.4 0 0.0 )  (position 5.6 1.6 0.0 ) "Silicon" "n_well" )
(sdedr:define-refeval-window 
...
(sdegeo:create-rectangle 
  (position 0.4 -0.14 0.0 )  (position 1.25 0 0.0 ) "Gold" "cathode1_contact" )
...
(sdegeo:create-rectangle 
  (position 4.75 -0.14 0.0 )  (position 5.6 0 0.0 ) "Gold" "cathode_contact" )
...
(sdegeo:create-rectangle 
  (position 0.4 0 0.0 )  (position 1.25 0.15 0.0 ) "Silicon" "n+_1" )
(sdedr:define-refeval-window 
  "RefEvalWin_n+Implant_1" "Rectangle"  (position 0.4 0 0.0 )  (position 1.25 0.15 0.0 ))
(sdedr:define-constant-profile 
...
(sdegeo:create-rectangle 
  (position 4.75 0 0.0 )  (position 5.6 0.15 0.0 ) "Silicon" "n+" )
(sdedr:define-refeval-window 
  "RefEvalWin_n+Implant" "Rectangle"  (position 4.75 0 0.0 )  (position 5.6 0.15 0.0 ))
(sdedr:define-constant-profile 
...
(sdegeo:create-rectangle 
  (position 1.25 0 0.0 )  (position 2 0.43 0.0 ) "Oxide" "STI_1" )
...
(sdegeo:create-rectangle 
  (position 4 0 0.0 )  (position 4.75 0.43 0.0 ) "Oxide" "STI" )
...
(sdegeo:create-rectangle 
  (position 0 0 0.0 )  (position 0.4 0.43 0.0 ) "Oxide" "STI_left" )
(sdegeo:create-rectangle 
  (position 5.6 0 0.0 )  (position 6.0 0.43 0.0 ) "Oxide" "STI_right" )


;----------------------------------------------------------------------
; Build Mesh 
(sde:build-mesh "snmesh" " " "sde_2d_2_msh")
