...
(sdegeo:create-rectangle 
  (position 0 0 0.0 )  (position 7 3 0.0 ) "Silicon" "p_substrate" )
(sdedr:define-refeval-window 
  "RefEvalWin_pSubstrate" "Rectangle"  (position 0 0 0.0 )  (position 7 3 0.0 ))
...
(sdegeo:create-rectangle 
  (position 0.55 0 0.0 )  (position 6.45 1.6 0.0 ) "Silicon" "n_well" )
(sdedr:define-refeval-window 
  "RefEvalWin_nWell" "Rectangle"  (position 0.55 0 0.0 )  (position 6.45 1.6 0.0 ))
(sdedr:define-constant-profile 
...
(sdegeo:create-rectangle 
  (position 5.6 -0.14 0.0 )  (position 6.45 0 0.0 ) "Gold" "cathode_contact" )
(sdegeo:define-contact-set "cathode" 4 (color:rgb 1 0 0) "##")
(sdegeo:set-current-contact-set "cathode")
(sdegeo:define-2d-contact (find-edge-id (position 6.025 0 0))
(sdegeo:get-current-contact-set))

(sdegeo:create-rectangle 
  (position 3.36 -0.14 0.0 )  (position 3.64 0 0.0 ) "Gold" "anode_contact" )
(sdegeo:define-contact-set "anode" 4 (color:rgb 1 0 0) "##")
(sdegeo:set-current-contact-set "anode")
(sdegeo:define-2d-contact (find-edge-id (position 3.5 -0.14 0))
(sdegeo:get-current-contact-set))
...
(sdegeo:create-rectangle 
  (position 5.6 0 0.0 )  (position 6.45 0.15 0.0 ) "Silicon" "n+" )
(sdedr:define-refeval-window 
  "RefEvalWin_n+Implant" "Rectangle"  (position 5.6 0 0.0 )  (position 6.45 0.15 0.0 ))
(sdedr:define-constant-profile 
...
(sdegeo:create-rectangle 
  (position 2.25 0 0.0 )  (position 4.75 0.2 0.0 ) "Silicon" "p+" )
(sdedr:define-refeval-window 
  "RefEvalWin_p+Implant" "Rectangle"  (position 2 0 0.0 )  (position 5 0.2 0.0 ))
(sdedr:define-constant-profile 
...
(sdedr:define-refeval-window 
  "RefEvalWin_p+Implant_1" "Rectangle"  (position (- 2.25 0.1) 0 0.0 )  (position (+ 4.75 0.1) (+ 0.2 0.05) 0.0 ))
(sdedr:define-multibox-placement 
  "MultiboxPlacement_p+Implant" "MultiboxDefinition_p+Implant" "RefEvalWin_p+Implant_1" )

(sdegeo:create-rectangle 
  (position 1.4 0 0.0 )  (position 2.25 0.43 0.0 ) "Oxide" "STI_1" )
...
(sdedr:define-refeval-window 
  "RefEvalWin_STI_1_2" "Rectangle"  (position (- 2.25 0.1) 0 0.0 )  (position (+ 2.25 0.1) (+ 0.43 0.05) 0.0 ))
(sdedr:define-multibox-placement 
...
(sdedr:define-refeval-window 
  "RefEvalWin_STI_1_3" "Rectangle"  (position (- 1.2 0.1) (- 0.43 0.1) 0.0 )  (position (+ 2.25 0.1) (+ 0.43 0.1) 0.0 ))
(sdedr:define-multibox-placement 
  "MultiboxPlacement_STI_1_3" "MultiboxDefinition_STI_1_3" "RefEvalWin_STI_1_3" )

(sdegeo:create-rectangle 
  (position 4.75 0 0.0 )  (position 5.6 0.43 0.0 ) "Oxide" "STI" )
(sdedr:define-multibox-size "MultiboxDefinition_STI_1" 0.05 0.05 0 0.01 0.01 0 1.2 1.2 1 )
(sdedr:define-refeval-window 
  "RefEvalWin_STI_1" "Rectangle"  (position (- 4.75 0.1) 0 0.0 )  (position (+ 4.75 0.1) (+ 0.43 0.05) 0.0 ))
(sdedr:define-multibox-placement 
...
(sdedr:define-refeval-window 
  "RefEvalWin_STI_2" "Rectangle"  (position (- 5.8 0.1) 0 0.0 )  (position (+ 5.8 0.1) (+ 0.43 0.05) 0.0 ))
(sdedr:define-multibox-placement 
...
(sdedr:define-refeval-window 
  "RefEvalWin_STI_3" "Rectangle"  (position (- 4.75 0.1) (- 0.43 0.1) 0.0 )  (position (+ 5.8 0.1) (+ 0.43 0.1) 0.0 ))
(sdedr:define-multibox-placement 
...
(sdegeo:create-rectangle 
  (position 6.45 0 0.0 )  (position 7.0 0.43 0.0 ) "Oxide" "STI_right" )


;----------------------------------------------------------------------
; Build Mesh 
(sde:build-mesh "snmesh" " " "sde_2d_4_msh")
