...
File {
    Grid = "sde_2d_4_msh.tdr"
    Plot = "sde_2d_4_des.tdr"
    Output = "sde_2d_4_des.log"
    Current = "sde_2d_4_des.plt"
...
Physics {
	...
	OpticalGeneration (ComputeFromMonochromaticSource QuantumYield (EffectiveAbsorption StepFunction (EffectiveBandgap)))
	Excitation (
