...
File {
	...
	Plot      = "Cprime_prelims_1095.dat"
	Current   = "Cprime_prelims_1095.plt"
	Output    = "Cprime_prelims_1095.log"
	NonLocalPlot=   "n1095_nonlocal.plt"
	Parameter = "pp1095_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1095")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1095"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1095")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1095_0001")
	NewCurrentFile=""
