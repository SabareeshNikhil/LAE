...
(do ( (i 0 (+ i 1)) ) ; i: Counter name; 0: initial value; (+ i 1): incrementer 
 ...
 (begin            ; Body of loop
  ...
  (sdegeo:create-rectangle (position xfinlow newyfinlow 0) (position xoxidelow newyfinhigh 0)  "Germanium" SFIN)
...
; inside the fin
(sdedr:define-refinement-window "G2" "Line" (position 0.1389 0.1525  0) (position  0.1389 0.1475  0))
...
(sdedr:define-refinement-window "G2_1" "Line" (position 0.1389 0.1525  0) (position  0.1389 0.1475  0))
...
(sdedr:define-refinement-window "G1" "Line" (position 0.1611 0.1525  0) (position  0.1611 0.1475  0))
...
(sdedr:define-refinement-window "G1_1" "Line" (position 0.1611 0.1525  0) (position  0.1611 0.1475  0))
...
(sde:build-mesh "mesh" "-F tdr " "2d_Lg_15_1011")
