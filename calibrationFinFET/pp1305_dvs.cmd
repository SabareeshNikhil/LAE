...
; inside the fin
(sdedr:define-refinement-window "G2" "Line" (position 0.1214 0.1525  0) (position  0.1214 0.1475  0))
...
(sdedr:define-refinement-window "G2_1" "Line" (position 0.1214 0.1525  0) (position  0.1214 0.1475  0))
...
(sdedr:define-refinement-window "G1" "Line" (position 0.1786 0.1525  0) (position  0.1786 0.1475  0))
...
(sdedr:define-refinement-window "G1_1" "Line" (position 0.1786 0.1525  0) (position  0.1786 0.1475  0))
...
(sde:build-mesh "mesh" "-F tdr " "2d_Lg_15_1305")
