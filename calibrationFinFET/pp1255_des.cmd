...
File {
	...
	Plot      = "Cprime_prelims_1255.dat"
	Current   = "Cprime_prelims_1255.plt"
	Output    = "Cprime_prelims_1255.log"
	NonLocalPlot=   "n1255_nonlocal.plt"
	Parameter = "pp1255_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1255")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1255"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1255")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1255_0001")
	NewCurrentFile=""
