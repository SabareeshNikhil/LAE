...
File {
	...
	Plot      = "Cprime_prelims_1079.dat"
	Current   = "Cprime_prelims_1079.plt"
	Output    = "Cprime_prelims_1079.log"
	NonLocalPlot=   "n1079_nonlocal.plt"
	Parameter = "pp1079_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1079")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1079"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1079")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1079_0001")
	NewCurrentFile=""
