...
File {
	...
	Plot      = "Cprime_prelims_1127.dat"
	Current   = "Cprime_prelims_1127.plt"
	Output    = "Cprime_prelims_1127.log"
	NonLocalPlot=   "n1127_nonlocal.plt"
	Parameter = "pp1127_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1127")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1127"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1127")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1127_0001")
	NewCurrentFile=""
