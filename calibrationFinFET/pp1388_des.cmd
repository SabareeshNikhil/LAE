...
File {
	...
	Plot      = "Cprime_prelims_1388.dat"
	Current   = "Cprime_prelims_1388.plt"
	Output    = "Cprime_prelims_1388.log"
	NonLocalPlot=   "n1388_nonlocal.plt"
	Parameter = "pp1388_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1388")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1388"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1388")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1388_0001")
	NewCurrentFile=""
