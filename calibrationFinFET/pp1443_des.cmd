* DD
File {
	Grid      = "2d_Lg_15_1430_msh.tdr"
	Plot      = "Cprime_prelims_1443.dat"
	Current   = "Cprime_prelims_1443.plt"
	Output    = "Cprime_prelims_1443.log"
	NonLocalPlot=   "n1443_nonlocal.plt"
	Parameter = "pp1443_des.par"
}

Electrode{
	{ Name="source"    Voltage=0.0 }
	{ Name="drain"     Voltage=0.0 }
        { name=gate voltage=0.0 workfunction= 3.95837061395}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1443")
	...
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			MinStep=1e-10 MaxStep=0.05
			 Goal{ Name="drain" Voltage= 0.78  }
		       ){ Coupled{ Poisson Electron Hole} }
	
	plot (FilePrefix = "DrainRamped_1443")
	...
	*-  gate voltage sweep
	...
	Quasistationary(
			 ...
			 *Goal{ Name="substrate" Voltage= 0.78 }
		       ){ Coupled{ Poisson Electron Hole}
			CurrentPlot(Time=(Range=(0 1) Intervals=60))
			Save(FilePrefix="Vd_1443"
                        Time=(1))
		}
	* none
