...
File {
	...
	Plot      = "Cprime_prelims_1430.dat"
	Current   = "Cprime_prelims_1430.plt"
	Output    = "Cprime_prelims_1430.log"
	NonLocalPlot=   "n1430_nonlocal.plt"
	Parameter = "pp1430_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1430")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1430"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1430")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1430_0001")
	NewCurrentFile=""
