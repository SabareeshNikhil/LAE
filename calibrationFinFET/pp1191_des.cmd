...
File {
	...
	Plot      = "Cprime_prelims_1191.dat"
	Current   = "Cprime_prelims_1191.plt"
	Output    = "Cprime_prelims_1191.log"
	NonLocalPlot=   "n1191_nonlocal.plt"
	Parameter = "pp1191_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1191")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1191"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1191")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1191_0001")
	NewCurrentFile=""
	...
	Quasistationary(
			 ...
			 *Goal{ Name="substrate" Voltage= 0.6 }
		       ){ Coupled{ Poisson Electron Hole eQuantumPotential}
