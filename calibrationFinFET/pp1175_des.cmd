...
File {
	...
	Plot      = "Cprime_prelims_1175.dat"
	Current   = "Cprime_prelims_1175.plt"
	Output    = "Cprime_prelims_1175.log"
	NonLocalPlot=   "n1175_nonlocal.plt"
	Parameter = "pp1175_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1175")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1175"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1175")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1175_0001")
	NewCurrentFile=""
