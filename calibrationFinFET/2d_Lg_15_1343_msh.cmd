...
Definitions {
	...
	Refinement "FinMeshDef" {
		MaxElementSize = ( 0.010666666666667 0.0012 )
		MinElementSize = ( 0.010666666666667 0.0012 )
	}
...
Placements {
	...
	Constant "SourceExtDef" {
		...
		EvaluateWindow {
			Element = Rectangle [(0.05 0.131) (0.07 0.169)]
		}
	}
	Constant "DrainExtDef" {
		Reference = "DrainRegion"
		EvaluateWindow {
			Element = Rectangle [(0.23 0.131) (0.25 0.169)]
		}
	}
	Refinement "Ref1" {
	...
	Refinement "RefSrcExt" {
		...
		RefineWindow = Rectangle [(0.05 0.131) (0.07 0.169)]
	}
	Refinement "RefDrnExt" {
		Reference = "DrainExtMeshDef"
		RefineWindow = Rectangle [(0.23 0.131) (0.25 0.169)]
	}
	Refinement "RefFin" {
		Reference = "FinMeshDef"
		RefineWindow = Rectangle [(0.07 0.144) (0.23 0.156)]
	}
	Refinement "CRefFin" {
