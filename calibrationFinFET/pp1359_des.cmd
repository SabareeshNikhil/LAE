...
File {
	...
	Plot      = "Cprime_prelims_1359.dat"
	Current   = "Cprime_prelims_1359.plt"
	Output    = "Cprime_prelims_1359.log"
	NonLocalPlot=   "n1359_nonlocal.plt"
	Parameter = "pp1359_des.par"
}

Electrode{
	{ Name="source"    Voltage=0.0 }
	{ Name="drain"     Voltage=0.0 }
	{ Name="gate"     Voltage=0.0  Workfunction =  4.3157917}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1359")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1359"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1359")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1359_0001")
	NewCurrentFile=""
