...
File {
	...
	Plot      = "Cprime_prelims_1223.dat"
	Current   = "Cprime_prelims_1223.plt"
	Output    = "Cprime_prelims_1223.log"
	NonLocalPlot=   "n1223_nonlocal.plt"
	Parameter = "pp1223_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1223")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1223"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1223")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1223_0001")
	NewCurrentFile=""
