...
File {
	...
	Plot      = "Cprime_prelims_1239.dat"
	Current   = "Cprime_prelims_1239.plt"
	Output    = "Cprime_prelims_1239.log"
	NonLocalPlot=   "n1239_nonlocal.plt"
	Parameter = "pp1239_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1239")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1239"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1239")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1239_0001")
	NewCurrentFile=""
	...
	Quasistationary(
			 ...
			 *Goal{ Name="substrate" Voltage= 0.75 }
		       ){ Coupled{ Poisson Electron Hole eQuantumPotential}
