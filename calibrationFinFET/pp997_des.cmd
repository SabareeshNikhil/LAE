...
File {
	...
	Plot      = "Cprime_prelims_997.dat"
	Current   = "Cprime_prelims_997.plt"
	Output    = "Cprime_prelims_997.log"
	NonLocalPlot=   "n997_nonlocal.plt"
	Parameter = "pp997_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_997")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_997"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_997")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_997_0001")
	NewCurrentFile=""
