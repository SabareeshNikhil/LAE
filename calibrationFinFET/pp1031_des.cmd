...
File {
	...
	Plot      = "Cprime_prelims_1031.dat"
	Current   = "Cprime_prelims_1031.plt"
	Output    = "Cprime_prelims_1031.log"
	NonLocalPlot=   "n1031_nonlocal.plt"
	Parameter = "pp1031_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1031")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1031"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1031")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1031_0001")
	NewCurrentFile=""
