...
File {
	...
	Plot      = "2d_Lg_15_1440.dat"
	Current   = "2d_Lg_15_1440.plt"
	Output    = "2d_Lg_15_1440.log"
	Parameter = "pp1440_des.par"
	Load=  "Vd_1438_des.sav"
	MonteCarloOut = "n1440_mc"
}
...
MonteCarlo {
  ...
  Window = Rectangle[ (0.125,0.11933) (0.175,0.18067) ] # picasso -compat
FinalTime = 3.6e-07
...
solve {
         ...
         montecarlo
         plot(fileprefix="n1440_mc" overwrite) 
}
