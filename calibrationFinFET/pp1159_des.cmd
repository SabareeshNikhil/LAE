...
File {
	...
	Plot      = "Cprime_prelims_1159.dat"
	Current   = "Cprime_prelims_1159.plt"
	Output    = "Cprime_prelims_1159.log"
	NonLocalPlot=   "n1159_nonlocal.plt"
	Parameter = "pp1159_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1159")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1159"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1159")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1159_0001")
	NewCurrentFile=""
