* DD
File {
	Grid      = "2d_Lg_15_1361_msh.tdr"
	Plot      = "Cprime_prelims_1365.dat"
	Current   = "Cprime_prelims_1365.plt"
	Output    = "Cprime_prelims_1365.log"
	NonLocalPlot=   "n1365_nonlocal.plt"
	Parameter = "pp1365_des.par"
}
...
NonLocalPlot((0.15 0.14335) (0.15 0.15665))
...
Length=1.265e-06 Permeable Permeation=6.5e-08
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1365")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1365"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1365")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1365_0001")
	NewCurrentFile=""
	...
	Quasistationary(
			 ...
			 *Goal{ Name="gate" Voltage= 1.5 }
			 Goal{ Name="gate" Voltage= 1.5 }
			 *Goal{ Name="substrate" Voltage= 1.5 }
		       ){ Coupled{ Poisson Electron Hole eQuantumPotential}
