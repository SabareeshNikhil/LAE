...
File {
	...
	Plot      = "Cprime_prelims_1207.dat"
	Current   = "Cprime_prelims_1207.plt"
	Output    = "Cprime_prelims_1207.log"
	NonLocalPlot=   "n1207_nonlocal.plt"
	Parameter = "pp1207_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1207")
	...
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			MinStep=1e-10 MaxStep=0.05
			 Goal{ Name="drain" Voltage= 0.65  }
		       ){ Coupled{ Poisson Electron Hole eQuantumPotential} 
			

			
			Save(FilePrefix="Vd_1207"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1207")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1207_0001")
	NewCurrentFile=""
	...
	Quasistationary(
			 ...
			 *Goal{ Name="gate" Voltage= 0.65 }
			 Goal{ Name="gate" Voltage= 0.1 }
			 *Goal{ Name="substrate" Voltage= 0.65 }
		       ){ Coupled{ Poisson Electron Hole eQuantumPotential}
