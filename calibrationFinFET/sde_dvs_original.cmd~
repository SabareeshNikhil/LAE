...
(if (string=? "@Type@" "pMOS") 
 (begin
  (define DSD "GalliumActiveConcentration")
  (define DBody  "ArsenicActiveConcentration")
 )
 (begin 
  (define DSD "ArsenicActiveConcentration")
  (define DBody  "GalliumActiveConcentration")
 )
)
;----------------------------------------------------------------------;
...
(do ( (i 0 (+ i 1)) ) ; i: Counter name; 0: initial value; (+ i 1): incrementer 
 ...
 (begin            ; Body of loop
  ...
  (sdegeo:create-rectangle (position xfinlow newyfinlow 0) (position xoxidelow newyfinhigh 0)  "InGaAs" SFIN)
  (sdegeo:create-rectangle (position xoxidelow newyfinlow 0) (position xoxidehigh newyfinhigh 0)  "InGaAs" FIN)
  (sdegeo:create-rectangle (position xoxidehigh newyfinlow 0) (position xfinhigh newyfinhigh 0)  "InGaAs" DFIN)
...
;  (sdegeo:create-rectangle (position xoxidelow newyoxidelow 0) (position xoxidehigh newyoxidehigh 0) "HfO2" GateOxide)
  (sdegeo:create-rectangle (position xoxidelow newyoxidelow 0) (position xoxidehigh newyoxidehigh 0) "InGaAs" GateOxide)
...
; inside the fin
(sdedr:define-refinement-window "G2" "Line" (position @<(0.15-(L*1e-3/2.)-(nmperdec*decades*1e-3))>@ @<(W*1e-3/2.)+0.15>@  0) (position  @<(0.15-(L*1e-3/2.)-(nmperdec*decades*1e-3))>@ @<0.15- (W*1e-3/2.)>@  0))
...
(sdedr:define-refinement-window "G2_1" "Line" (position @<(0.15-(L*1e-3/2.)-(nmperdec*decades*1e-3))>@ @<(W*1e-3/2.)+0.15>@  0) (position  @<(0.15-(L*1e-3/2.)-(nmperdec*decades*1e-3))>@ @<0.15- (W*1e-3/2.)>@  0))
(sdedr:define-gaussian-profile "G2_Prof_1" DSD "PeakPos" 0  "PeakVal" (* 2 Na) "ValueAtDepth" Nd "Depth" @<(nmperdec * decades*1e-3)>@ "Gauss" "Length" 0)
(sdedr:define-analytical-profile-placement "G2_def_1" "G2_Prof_1" "G2_1" "Positive" "NoReplace" "NoEval")

(sdedr:define-refinement-window "G1" "Line" (position @<(0.15+(L*1e-3/2.)+(nmperdec*decades*1e-3))>@ @<(W*1e-3/2.)+0.15>@  0) (position  @<(0.15+(L*1e-3/2.)+(nmperdec*decades*1e-3))>@ @<0.15- (W*1e-3/2.)>@  0))
(sdedr:define-gaussian-profile "G1_Prof" DSD "PeakPos" 0  "PeakVal" (* 2 Na) "ValueAtDepth" (* 2 Na) "Depth" @<(nmperdec * decades*1e-3)>@ "Gauss" "Length" 0)
(sdedr:define-analytical-profile-placement "G1_def" "G1_Prof" "G1" "Positive" "NoReplace" "NoEval")

(sdedr:define-refinement-window "G1_1" "Line" (position @<(0.15+(L*1e-3/2.)+(nmperdec*decades*1e-3))>@ @<(W*1e-3/2.)+0.15>@  0) (position  @<(0.15+(L*1e-3/2.)+(nmperdec*decades*1e-3))>@ @<0.15- (W*1e-3/2.)>@  0))
(sdedr:define-gaussian-profile "G1_Prof_1" DSD "PeakPos" 0  "PeakVal" (* 2 Na) "ValueAtDepth" Nd "Depth" @<(nmperdec * decades*1e-3)>@ "Gauss" "Length" 0)
...
(sdedr:define-refinement-size "UnivMeshDef" 0.001 0.001 0.001 0.001 0.001 0.001)
...
(sdedr:define-refinement-size "FinMeshDef" (/ Lfin 120) (/ Wfin 25) (/ Lfin 120) (/ Wfin 25))
...
(sdedr:define-refinement-size "CFinMeshDef" (/ Lgate 80) (/ Wfin 25) (/ Lgate 80) (/ Wfin 25))
...
(sdedr:define-refinement-size "Ch0MeshDef" (/ Lgate 25) (/ debye_length 0.5) (/ Lgate 25) (/ debye_length 0.5) )
...
(sdedr:define-refinement-size "Ch1MeshDef" (/ Lgate 25) (/ debye_length 0.5) (/ Lgate 25) (/ debye_length 0.5) )
...
(sdedr:define-refinement-size "BackOxideMeshDef" (/ Lgate 30) (/ EOT 15) (/ Lgate 30) (/ EOT 15) )
...
(sdedr:define-refinement-size "FntOxideMeshDef" (/ Lgate 30) (/ EOT 15) (/ Lgate 30) (/ EOT 15) )
...
(sdedr:define-refinement-size "BackGateChMeshDef" (/ Lgate 30) (/ junction_refine 8) (/ Lgate 30) debye_length )
...
(sdedr:define-refinement-size "FntGateChMeshDef" (/ Lgate 30) (/ junction_refine 8) (/ Lgate 30) debye_length )
...
(sdedr:define-refinement-size "GateMeshDef0" (/ Lgate 10) (/ Wgate 5) (/ Lgate 13) (/ Wgate 7) )
...
(sdedr:define-refinement-size "GateMeshDef2" (/ Lgate 10) (/ Wgate 5) (/ Lgate 13) (/ Wgate 7) )
(sdedr:define-refinement-placement "RefGate2" "GateMeshDef2" "GateMesh2" )

(sde:build-mesh "mesh" "-F tdr " "2d_Lg_15_@node@")
