...
File {
	...
	Plot      = "Cprime_prelims_1404.dat"
	Current   = "Cprime_prelims_1404.plt"
	Output    = "Cprime_prelims_1404.log"
	NonLocalPlot=   "n1404_nonlocal.plt"
	Parameter = "pp1404_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1404")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1404"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1404")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1404_0001")
	NewCurrentFile=""
