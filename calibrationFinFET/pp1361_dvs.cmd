...
; inside the fin
(sdedr:define-refinement-window "G2" "Line" (position 0.0714 0.156  0) (position  0.0714 0.144  0))
...
(sdedr:define-refinement-window "G2_1" "Line" (position 0.0714 0.156  0) (position  0.0714 0.144  0))
...
(sdedr:define-refinement-window "G1" "Line" (position 0.2286 0.156  0) (position  0.2286 0.144  0))
...
(sdedr:define-refinement-window "G1_1" "Line" (position 0.2286 0.156  0) (position  0.2286 0.144  0))
...
(sdedr:define-refinement-size "UnivMeshDef" 0.02 0.02 0.02 0.02 0.02 0.02)
...
(sdedr:define-refinement-size "FinMeshDef" (/ Lfin 15) (/ Wfin 10) (/ Lfin 15) (/ Wfin 10))
...
(sdedr:define-refinement-size "CFinMeshDef" (/ Lgate 15) (/ Wfin 10) (/ Lgate 15) (/ Wfin 10))
...
(sdedr:define-refinement-size "Ch0MeshDef" (/ Lgate 10) (/ debye_length 0.5) (/ Lgate 10) (/ debye_length 0.5) )
...
(sdedr:define-refinement-size "Ch1MeshDef" (/ Lgate 10) (/ debye_length 0.5) (/ Lgate 10) (/ debye_length 0.5) )
...
(sdedr:define-refinement-size "BackOxideMeshDef" (/ Lgate 20) (/ EOT 15) (/ Lgate 20) (/ EOT 15) )
...
(sdedr:define-refinement-size "FntOxideMeshDef" (/ Lgate 20) (/ EOT 15) (/ Lgate 20) (/ EOT 15) )
...
(sdedr:define-refinement-size "BackGateChMeshDef" (/ Lgate 20) (/ junction_refine 8) (/ Lgate 20) debye_length )
...
(sdedr:define-refinement-size "FntGateChMeshDef" (/ Lgate 20) (/ junction_refine 8) (/ Lgate 20) debye_length )
...
(sde:build-mesh "mesh" "-F tdr " "2d_Lg_15_1361")
