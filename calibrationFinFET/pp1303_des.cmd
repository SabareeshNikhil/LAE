...
File {
	...
	Plot      = "Cprime_prelims_1303.dat"
	Current   = "Cprime_prelims_1303.plt"
	Output    = "Cprime_prelims_1303.log"
	NonLocalPlot=   "n1303_nonlocal.plt"
	Parameter = "pp1303_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1303")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1303"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1303")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1303_0001")
	NewCurrentFile=""
