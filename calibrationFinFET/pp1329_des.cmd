...
File {
	...
	Plot      = "Cprime_prelims_1329.dat"
	Current   = "Cprime_prelims_1329.plt"
	Output    = "Cprime_prelims_1329.log"
	NonLocalPlot=   "n1329_nonlocal.plt"
	Parameter = "pp1329_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1329")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1329"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1329")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1329_0001")
	NewCurrentFile=""
