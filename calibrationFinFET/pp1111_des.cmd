...
File {
	...
	Plot      = "Cprime_prelims_1111.dat"
	Current   = "Cprime_prelims_1111.plt"
	Output    = "Cprime_prelims_1111.log"
	NonLocalPlot=   "n1111_nonlocal.plt"
	Parameter = "pp1111_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1111")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1111"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1111")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1111_0001")
	NewCurrentFile=""
	...
	Quasistationary(
			 ...
			 *Goal{ Name="substrate" Voltage= -0.7 }
		       ){ Coupled{ Poisson Electron Hole hQuantumPotential}
