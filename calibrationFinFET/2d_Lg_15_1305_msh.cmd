...
Definitions {
	...
	Refinement "FinMeshDef" {
		MaxElementSize = ( 0.0005 0.0002 )
		MinElementSize = ( 0.0005 0.0002 )
	}
	Refinement "CFinMeshDef" {
		MaxElementSize = ( 0.000625 0.0002 )
		MinElementSize = ( 0.000625 0.0002 )
	}
	Refinement "Ch0MeshDef" {
		MaxElementSize = ( 0.002 3e-05 )
		MinElementSize = ( 0.002 3e-05 )
	}
	...
	Refinement "BackOxideMeshDef" {
		MaxElementSize = ( 0.0016666666666667 4.4666666666667e-05 )
		MinElementSize = ( 0.0016666666666667 4.4666666666667e-05 )
	}
	...
	Refinement "BackGateChMeshDef" {
		MaxElementSize = ( 0.0016666666666667 0.0001875 )
		MinElementSize = ( 0.0016666666666667 1.5e-05 )
	}
	...
	Refinement "GateMeshDef0" {
		MaxElementSize = ( 0.005 0.009268 )
		MinElementSize = ( 0.0038461538461538 0.00662 )
	}
...
Placements {
	Constant "ChDef_1.0" {
		...
		EvaluateWindow {
			Element = Rectangle [(0.125 0.1475) (0.175 0.1525)]
		}
	}
	AnalyticalProfile "G2_def" {
		Reference = "G2_Prof"
		ReferenceElement {
			Element = Line [(0.1214 0.1525) (0.1214 0.1475)]
			Direction = negative
		}
		notevalline
	}
	...
	AnalyticalProfile "G1_def" {
		Reference = "G1_Prof"
		ReferenceElement {
			Element = Line [(0.1786 0.1525) (0.1786 0.1475)]
			Direction = positive
		}
		notevalline
	}
	...
	Constant "SourceExtDef" {
		...
		EvaluateWindow {
			Element = Rectangle [(0.1 0.1345) (0.12 0.1655)]
		}
	}
	Constant "DrainExtDef" {
		Reference = "DrainRegion"
		EvaluateWindow {
			Element = Rectangle [(0.18 0.1345) (0.2 0.1655)]
		}
	}
	Refinement "Ref1" {
	...
	Refinement "RefSrcExt" {
		...
		RefineWindow = Rectangle [(0.1 0.1345) (0.12 0.1655)]
	}
	Refinement "RefDrnExt" {
		Reference = "DrainExtMeshDef"
		RefineWindow = Rectangle [(0.18 0.1345) (0.2 0.1655)]
	}
	Refinement "RefFin" {
		Reference = "FinMeshDef"
		RefineWindow = Rectangle [(0.12 0.1475) (0.18 0.1525)]
	}
	Refinement "CRefFin" {
		Reference = "CFinMeshDef"
		RefineWindow = Rectangle [(0.12499 0.1475) (0.17501 0.1525)]
	}
	Refinement "RefCh0" {
		Reference = "Ch0MeshDef"
		RefineWindow = Rectangle [(0.125 0.1475) (0.175 0.149166666667)]
	}
	Refinement "RefCh1" {
		Reference = "Ch1MeshDef"
		RefineWindow = Rectangle [(0.125 0.150833333333) (0.175 0.1525)]
	}
	Refinement "RefBackOxide" {
		Reference = "BackOxideMeshDef"
		RefineWindow = Rectangle [(0.12499 0.1525) (0.17501 0.15317)]
	}
	Refinement "RefFntOxide" {
		Reference = "FntOxideMeshDef"
		RefineWindow = Rectangle [(0.12499 0.14683) (0.17501 0.1475)]
	}
	Refinement "RefBackGateCh" {
		Reference = "BackGateChMeshDef"
		RefineWindow = Rectangle [(0.12499 0.1525) (0.17501 0.152607142857)]
	}
	Refinement "RefFntGateCh" {
		Reference = "FntGateChMeshDef"
		RefineWindow = Rectangle [(0.12499 0.147392857143) (0.17501 0.1475)]
	}
	Refinement "RefGate0" {
		Reference = "GateMeshDef0"
		RefineWindow = Rectangle [(0.125 0.12683) (0.17501 0.14683)]
	}
	Refinement "RefGate2" {
		Reference = "GateMeshDef2"
		RefineWindow = Rectangle [(0.12499 0.1525) (0.175 0.17317)]
	}
}
