...
File {
	...
	Plot      = "Cprime_prelims_1287.dat"
	Current   = "Cprime_prelims_1287.plt"
	Output    = "Cprime_prelims_1287.log"
	NonLocalPlot=   "n1287_nonlocal.plt"
	Parameter = "pp1287_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1287")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1287"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1287")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1287_0001")
	NewCurrentFile=""
