...
Definitions {
	...
	Refinement "UnivMeshDef" {
		MaxElementSize = ( 0.01 0.001 0.001 )
		MinElementSize = ( 0.01 0.001 0.001 )
	}
	...
	Refinement "FinMeshDef" {
		MaxElementSize = ( 0.008 0.005 )
		MinElementSize = ( 0.008 0.005 )
	}
	Refinement "CFinMeshDef" {
		MaxElementSize = ( 0.0075 0.005 )
		MinElementSize = ( 0.0075 0.005 )
	}
	Refinement "Ch0MeshDef" {
		MaxElementSize = ( 0.01875 3e-05 )
		MinElementSize = ( 0.01875 3e-05 )
	}
	...
	Refinement "BackOxideMeshDef" {
		MaxElementSize = ( 0.03 0.00022 )
		MinElementSize = ( 0.03 0.00022 )
	}
	...
	Refinement "BackGateChMeshDef" {
		MaxElementSize = ( 0.03 0.0001875 )
		MinElementSize = ( 0.03 1.5e-05 )
	}
	...
	Refinement "GateMeshDef0" {
		MaxElementSize = ( 0.03 0.01844 )
		MinElementSize = ( 0.03 0.01844 )
	}
...
Placements {
	...
	Refinement "RefBackOxide" {
		...
		RefineWindow = Rectangle [(0.07499 0.175) (0.22501 0.1761)]
	}
	Refinement "RefFntOxide" {
		Reference = "FntOxideMeshDef"
		RefineWindow = Rectangle [(0.07499 0.1239) (0.22501 0.125)]
	}
	...
	Refinement "RefGate0" {
		...
		RefineWindow = Rectangle [(0.075 0.1039) (0.22501 0.1239)]
	}
	Refinement "RefGate2" {
		Reference = "GateMeshDef2"
		RefineWindow = Rectangle [(0.07499 0.175) (0.225 0.1961)]
	}
}
