...
File {
	...
	Plot      = "Cprime_prelims_1309.dat"
	Current   = "Cprime_prelims_1309.plt"
	Output    = "Cprime_prelims_1309.log"
	NonLocalPlot=   "n1309_nonlocal.plt"
	Parameter = "pp1309_des.par"
}
...
Solve {
	*- Build-up of initial solution:
	...
	plot (FilePrefix = "OnlyPoisson_1309")
	...
	*- Bias drain to target bias
	Quasistationary(
			* InitialStep=0.01 Increment=1.35 
			...
			Save(FilePrefix="Vd_1309"
                        Time=(Range=(0 1) intervals=1)
                        nooverwrite)
			}
	
	plot (FilePrefix = "DrainRamped_1309")

	*-  gate voltage sweep
	Load (FilePrefix = "Vd_1309_0001")
	NewCurrentFile=""
